...
// Görsel kısım ayrı client component — animasyonlar LCP'yi etkilemez
...
export const HeroVisual = ({ image, whatsapp }: HeroVisualProps) => {
  return (
    <motion.div
    ...
    >
      ...
      >
        ...
        {/* Hero görseli — doğru sizes: mobilde tam genişlik, lg'de ~600px */}
